...
public class Transition implements Comparable<Transition> {
	...
	public int compareTo(Transition other) {
		int timeDiff = Double.compare(this.arrivalTime,other.arrivalTime);
		return (timeDiff == 0 ? Integer.compare(this.priority,other.priority) : timeDiff);
	}
	...
	public boolean equals(Object o) {
		if (o instanceof Transition) {
			...
			return (this.index == other.index && this.arrivalTime == other.arrivalTime && this.source == other.source && 
				this.target == other.target && this.priority == other.priority);
		}
		else {
			return false;
		}
